...
$.fn.jqResize=function(r,o){$.jqDnR.init(this,r,'r',o); return this;}
$.jqDnR={
init:function(w,r,t,o){ r=(r)?$(r,w):w;
	r.bind('mousedown',{w:w,t:t,_o:o},function(e){ var h=e.data; var w=h.w;
...
drag:function(e) {var h=hash; var w=h.w[0];
	if(h.t == 'd') h.w.css({left:h.oX + e.pageX - h.pX,top:h.oY + e.pageY - h.pY});
        ...
        var width=Math.max(e.pageX - h.pX + h.oW,0);
        var height=Math.max(e.pageY - h.pY + h.oH,0);
        h.w.css({width:width,height:height});
        if(h._o && h._o.resize){
            h._o.resize(width, height);
        }
    }
	return false;},
